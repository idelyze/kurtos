    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full px-10 grid grid-cols-1 md:grid-cols-2 gap-16 items-center py-32 md:py-0">
        ...
        >
          ...
          >
            Late Night Cravings? We’re Open Till 4:30 AM
          </motion.p>
          ...
          >
            Freshly Baked
            <br />
            <em className="italic text-caramel">Kurtos</em>
            <br />
            Hot, Crispy &
            <br />
          ...
          >
            Baked on open flame, never fried. Crispy outside, soft inside, filled your way — chocolate, cheese, paneer or fully loaded. Served hot, every single time.
          </motion.p>
